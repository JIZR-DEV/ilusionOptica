    ...
    private void initComponents() {
        ...
        jPanel5 = new javax.swing.JPanel(){
            protected void paintComponent(Graphics g) {
                ...
                for (int i = 0; i <= w/2; i+=5){
                    // Líneas diagonales hacia abajo desde la parte superior
                    g.drawLine(i, i, w/2, h - i);
                    g.drawLine(w - i, i, w/2, h - i);

                    // Líneas horizontales para conectar las líneas diagonales y formar triángulos
                    g.drawLine(i, i, w - i, i);

                    // Líneas verticales para dar la ilusión de una cuadrícula que se curva hacia el centro
        ...
        jPanel9 = new javax.swing.JPanel(){
            protected void paintComponent(Graphics g) {
                ...
                for (int i = 0; i <= h; i+=10){
                    g.drawLine(i, w, h, w - h);
                    g.drawLine(h, i, w - i, w);
                }
            }
        };
        ...
        jLabel2.setText("Ejemplo 7");

        jLabel3.setText("Ejemplo 5");

        jLabel4.setText("Ejemplo 9");

        jLabel5.setText("Extra 4");

        jLabel6.setText("Extra 3");

        jLabel7.setText("Extra 2");

        jLabel8.setText("Extra 1");
